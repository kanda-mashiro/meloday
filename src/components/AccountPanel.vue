          ...
          <div v-else class="acctp__providers">
            <div v-for="p in PROVIDERS" :key="p.id" class="acctp__provider">
              <span class="acctp__provider-ico" aria-hidden="true">
                ...
                <svg v-else viewBox="0 0 24 24" fill="currentColor"><path d="M12 11v3.2h4.5c-.2 1.16-1.4 3.4-4.5 3.4a4.6 4.6 0 0 1 0-9.2c1.43 0 2.4.6 2.95 1.13l2.01-1.94A7.6 7.6 0 0 0 12 4.4a7.6 7.6 0 1 0 0 15.2c4.39 0 7.3-3.08 7.3-7.42 0-.5-.06-.88-.13-1.18H12z"/></svg>
              </span>
